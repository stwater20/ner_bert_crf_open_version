...
max_seq_length = 256
output_dir = os.getenv("HOME")+'/Desktop/ner_bert_crf_open_version/outputs/'

def get_data_dir(local_path="Desktop/ner_bert_crf_open_version", server_path="ner_bert_crf_open_version"):
...
class InputExample(object):
    def __init__(self, guid, words, labels):
        ...
        """
        self.guid = guid
        # list of words of the sentence,example
        self.words = words
        # list of label sequence of the sentence
        self.labels = labels
